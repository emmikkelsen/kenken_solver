...
func permutations(boardSize: Int, groupSize: Int, operation: Operation, result: Int) -> [Permutation] {
...
func peAdd(boardSize: Int, result: Int, groupSize: Int) -> [Permutation] {
    if (groupSize == 1) {
        return [[result]];
    }
    var t: [[Int]] = [];
...
func peMultiply(boardSize: Int, result: Int, groupSize: Int) -> [Permutation] {
    if (groupSize == 1) {
        return [[result]];
    }
    var t: [[Int]] = [];
